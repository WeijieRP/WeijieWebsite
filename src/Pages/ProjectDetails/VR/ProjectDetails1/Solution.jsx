...
export default function BrandMeSolution({
  ...
  description = [
    "I designed a normal business card first with the logo, name, title, and contact details as the main focus, so it works in real life.",
    "Then I added AR using Vuforia, so the card gets recognised fast and a small 3D element pops up on top.",
    "I kept the AR subtle by using strong visual features for tracking, smooth animation, and matching the lighting so it feels natural on a phone.",
  ],
}) {
      ...
      <div className="bms-inner bms-balance">
        ...
        <figure className="bms-figure slide-right" data-ani>
          <div className="bms-lightcard">
            {/* ✅ image fills whole card now */}
            <img
              className="bms-media cover-mode"
              src={visual}
